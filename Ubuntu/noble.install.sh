...
#
# noble.install.sh: 
#    This script installs Bodhi Linux 8.x on an existing Ubuntu 24.04 install.
...
echo "This script will install Moksha on Ubuntu 24.04 (noble)."
echo
...
# Test lsb_release to see if Noble
...
wget http://packages.bodhilinux.com/bodhi/pool/b8main/b/bodhilinux-keyring/bodhilinux-keyring_2022.11.07_all.deb
wget http://packages.bodhilinux.com/bodhi/pool/b8main/u/ubuntu-system-adjustments/ubuntu-system-adjustments_0.0.1-3_all.deb	
wget http://packages.bodhilinux.com/bodhi/pool/b8main/b/bodhi-info-moksha/bodhi-info-moksha_0.0.1-1_all.deb
wget http://packages.bodhilinux.com/bodhi/pool/b8main/b/bodhi-apt-source/bodhi-apt-source_0.0.1-1_all.deb
